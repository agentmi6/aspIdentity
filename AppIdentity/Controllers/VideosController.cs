...
namespace AppIdentity.Controllers
{
    ...
    public class VideosController : Controller
    {
        ...
        // GET: Videos
        public ActionResult Index(string tag, string searchString)
        {
            if (!string.IsNullOrWhiteSpace(tag))

            {
                var filtered = db.Videos
                    .Where(x => x.tags.Contains(tag) && x.isApproved=="A").ToList();

                return View(filtered);
            }            

           return View(db.Videos.Where(x=>x.isApproved=="A").ToList());

        }

        [Authorize(Roles = "admin")]
        public ActionResult VList()
        {
